...
Gives each reference file under .agents/skills/*/references/ a `semantic_id` whose
...
Usage
-----
  python3 .agents/scripts/stamp_semantic_ids.py            # stamp all, print health
  python3 .agents/scripts/stamp_semantic_ids.py --health   # only report, do not write
  python3 .agents/scripts/stamp_semantic_ids.py path/to/one.md [more.md ...]
"""
import base64
import glob
import itertools
...
# repo root = two levels up from this file (.agents/scripts/ -> repo)
REPO = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
GLOB = os.path.join(REPO, ".agents/skills/*/references/*.md")
